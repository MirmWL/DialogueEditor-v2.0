public class SpeechNodeFactory : IFactory<INode>
{
    ...
    {
        var clickInput = new EventInput(new PredicateDependentInput(new InRect(rect, _mousePosition), new Click()));
        var dragInput = new EventInput(new PredicateDependentInput(new InRect(rect, _mousePosition), new Drag()));
